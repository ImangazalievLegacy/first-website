...
<p>Ник: </p> 
<input type="text" name="username" value="<?php echo $_SESSION['username']; unset($_SESSION['username']); ?>" />
<p>E-mail: </p> 
<input type="text" name="email" value="<?php echo $_SESSION['email']; unset($_SESSION['email']); ?>" />
<p>Пароль: </p> 
<input id="pass" type="password" name="pass" value="<?php echo $_SESSION['pass']; unset($_SESSION['pass']); ?>" /><label>
